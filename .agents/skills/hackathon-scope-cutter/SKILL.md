...
description: >-
  Cut a feature set down to what is re-buildable from scratch in 2 hours on-site (the QBH finals rule) while preserving demo impact. Use proactively whenever a plan or feature list grows, when PL drafts docs/plan.md, or when the TRD §5 rebuild plan exceeds its time budget.
---
