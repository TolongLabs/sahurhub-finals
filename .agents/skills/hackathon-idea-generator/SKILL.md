...
description: >-
  Generate candidate deliberately-useless product concepts for the Qwen Brainrot Hackathon brief. Use proactively whenever the product concept (docs/prd.md §1) is still TBD or being rethought — before any planning — then hand results to hackathon-idea-scoring.
---
